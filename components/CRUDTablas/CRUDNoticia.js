        ...
        <ScrollView>
            <View style={styles.center}>
                <Text style={styles.text}>Titulo de la Noticia:</Text>
                    <TextInput style={{marginVertical: '2%'}} value={respuesta.titulonoticia} onChangeText={(value) => EstablecerTexto("titulonoticia", value)}></TextInput>
            </View>
            <View style={styles.center}>
                <Text style={styles.text}>Especificacion de la Noticia:</Text>
                    <TextInput style={{marginVertical: '2%'}} value={respuesta.especificacionnoticia} onChangeText={(value) => EstablecerTexto("especificacionnoticia", value)}></TextInput>
            </View>
            <View style={styles.center}>
                <Text style={styles.text}>Fuente de la Noticia:</Text>
                    <TextInput style={{marginVertical: '2%'}} value={respuesta.fuentenoticia} onChangeText={(value) => EstablecerTexto("fuentenoticia", value)}></TextInput>
            </View>
